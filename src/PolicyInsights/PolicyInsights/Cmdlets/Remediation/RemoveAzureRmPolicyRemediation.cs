...
namespace Microsoft.Azure.Commands.PolicyInsights.Cmdlets.Remediation
{
    ...
    /// </summary>
    [Cmdlet("Remove", AzureRMConstants.AzureRMPrefix + "PolicyRemediation", DefaultParameterSetName = ParameterSetNames.ByName, SupportsShouldProcess = true), OutputType(typeof(bool))]
    public class RemoveAzureRmPolicyRemediation : RemediationCmdletBase
    {
